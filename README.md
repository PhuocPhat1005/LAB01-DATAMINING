...
### 2. [Tiền xử lý dữ liệu hình bảng] Cities15000
...
Dữ liệu có thể được tải qua link kaggle: https://www.kaggle.com/datasets/i2i2i2/cities-of-the-world/code
...
- **Nguồn dữ liệu:** GeoNames (https://download.geonames.org/export/dump/)
